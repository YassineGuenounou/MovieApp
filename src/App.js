...
function App() {
  ...
  return (
    ...
    <div className="App" style={{backgroundColor:"grey"}}>
      ...
      <BrowserRouter>
      <NavigationBar movies={movies} setMovies={setMovies} searchRating={searchRating} setSearchRating={setSearchRating} setSearchCondition={setSearchCondition}/>
      <Routes>
        <Route exact path="/" element={<Home/>}/>
        <Route path="/Movies" element={<MovieList searchRating={searchRating} movies={movies} searchCondition={searchCondition}/>}/>
